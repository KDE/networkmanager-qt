 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-access-pointinterface /space/kde/src/git/extragear/libs/libnm-qt/dbus/introspection/nm-access-point.xml
 *
