 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-access-pointinterface /space/kde/sources/git/libnm-qt/libs/solid/control/dbus/introspection/nm-access-point.xml
 *
