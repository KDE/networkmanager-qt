 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-agent-managerinterface /home/jgrulich/development/projects/libnm-qt/dbus/introspection/nm-agent-manager.xml
 *
