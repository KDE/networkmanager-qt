 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-device-adslinterface /space/kde/src/git/extragear/libs/libnm-qt/dbus/introspection/nm-device-adsl.xml
 *
