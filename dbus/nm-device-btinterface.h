 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-device-btinterface /space/kde/sources/git/libQtNetworkManager/libs/solid/control/dbus/introspection/nm-device-bt.xml
 *
