 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-device-ethernetinterface /space/kde/sources/git/libnm-qt/libs/solid/control/dbus/introspection/nm-device-ethernet.xml
 *
