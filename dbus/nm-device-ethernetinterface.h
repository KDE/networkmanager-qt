 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-device-ethernetinterface /space/kde/src/git/extragear/libs/libnm-qt/dbus/introspection/nm-device-ethernet.xml
 *
