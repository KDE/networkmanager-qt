 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-device-ethernetinterface /space/kde/sources/git/libQtNetworkManager/libs/solid/control/dbus/introspection/nm-device-ethernet.xml
 *
