 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-device-modeminterface /space/kde/sources/git/libnm-qt/libs/solid/control/dbus/introspection/nm-device-modem.xml
 *
