 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-device-wifiinterface /space/kde/src/git/extragear/libs/libnm-qt/dbus/introspection/nm-device-wifi.xml
 *
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<> ProbeCert(const QByteArray &ssid)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(ssid);
        return asyncCallWithArgumentList(QLatin1String("ProbeCert"), argumentList);
    }
