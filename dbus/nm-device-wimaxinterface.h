 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-device-wimaxinterface /space/kde/sources/git/libQtNetworkManager/libs/solid/control/dbus/introspection/nm-device-wimax.xml
 *
