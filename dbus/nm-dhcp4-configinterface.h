 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-dhcp4-configinterface /space/kde/sources/git/libQtNetworkManager/libs/solid/control/dbus/introspection/nm-dhcp4-config.xml
 *
