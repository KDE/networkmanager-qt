 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-dhcp6-configinterface /space/kde/sources/git/libnm-qt/libs/solid/control/dbus/introspection/nm-dhcp6-config.xml
 *
