 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-dhcp6-configinterface /space/kde/src/git/extragear/libs/libnm-qt/dbus/introspection/nm-dhcp6-config.xml
 *
