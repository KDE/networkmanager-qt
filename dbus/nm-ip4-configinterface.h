 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-ip4-configinterface /space/kde/sources/git/libQtNetworkManager/libs/solid/control/dbus/introspection/nm-ip4-config.xml
 *
