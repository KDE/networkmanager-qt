 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-managerinterface /space/kde/sources/git/libQtNetworkManager/libs/solid/control/dbus/introspection/nm-manager.xml
 *
