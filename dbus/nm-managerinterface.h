 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-managerinterface /space/kde/src/git/extragear/libs/libnm-qt/dbus/introspection/nm-manager.xml
 *
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusReply<QDBusObjectPath> AddAndActivateConnection(NMVariantMapMap connection, const QDBusObjectPath &device, const QDBusObjectPath &specific_object, QDBusObjectPath &active_connection)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(connection) << QVariant::fromValue(device) << QVariant::fromValue(specific_object);
