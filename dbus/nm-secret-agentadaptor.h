 ...
 * Command line was: qdbusxml2cpp -m -a nm-secret-agentadaptor -i secretagent.h -l NetworkManager::SecretAgent /space/kde/src/git/extragear/libs/libnm-qt/dbus/introspection/nm-secret-agent.xml
 *
