 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-secret-agentinterface /home/jgrulich/projects/libnm-qt/dbus/introspection/nm-secret-agent.xml
 *
...
#ifndef NMQT_SECRET_AGENTINTERFACE_H
#define NMQT_SECRET_AGENTINTERFACE_H
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<> DeleteSecrets(const QVariantMapMap &connection, const QDBusObjectPath &connection_path)
    {
        QList<QVariant> argumentList;
