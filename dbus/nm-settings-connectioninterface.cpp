 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-settings-connectioninterface /space/kde/src/git/extragear/libs/libnm-qt/dbus/introspection/nm-settings-connection.xml
 *
