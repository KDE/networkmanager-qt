 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-settings-connectioninterface /home/jgrulich/development/projects/libnm-qt/dbus/introspection/nm-settings-connection.xml
 *
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<> UpdateUnsaved(NMVariantMapMap properties)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(properties);
        return asyncCallWithArgumentList(QLatin1String("UpdateUnsaved"), argumentList);
    }
