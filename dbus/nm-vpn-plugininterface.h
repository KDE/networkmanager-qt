 ...
 * Command line was: qdbusxml2cpp -N -m -i generic-types.h -p nm-vpn-plugininterface /space/kde/src/git/extragear/libs/libnm-qt/dbus/introspection/nm-vpn-plugin.xml
 *
