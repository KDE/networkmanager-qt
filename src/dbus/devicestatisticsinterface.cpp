...
OrgFreedesktopNetworkManagerDeviceStatisticsInterface::OrgFreedesktopNetworkManagerDeviceStatisticsInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent)
