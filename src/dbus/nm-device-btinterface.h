 ...
 * Command line was: qdbusxml2cpp -N -m -i generictypes.h -p nm-device-btinterface /home/jgrulich/development/projects/libnm-qt/dbus/introspection/nm-device-bt.xml
 *
