 ...
 * Command line was: qdbusxml2cpp -N -m -i generictypes.h -p nm-device-olpc-meshinterface /home/jgrulich/development/projects/libnm-qt/dbus/introspection/nm-device-olpc-mesh.xml
 *
