 ...
 * Command line was: qdbusxml2cpp -N -m -i generictypes.h -p nm-device-wifiinterface /home/jgrulich/development/projects/libnm-qt/dbus/introspection/nm-device-wifi.xml
 *
...
#endif
public:
    OrgFreedesktopNetworkManagerDeviceWirelessInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = nullptr);
...
public Q_SLOTS: // METHODS
    ...
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(QLatin1String("GetAllAccessPoints"), argumentList);
    }
