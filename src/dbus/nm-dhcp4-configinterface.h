 ...
 * Command line was: qdbusxml2cpp -N -m -i generictypes.h -p nm-dhcp4-configinterface /home/jgrulich/development/projects/libnm-qt/dbus/introspection/nm-dhcp4-config.xml
 *
