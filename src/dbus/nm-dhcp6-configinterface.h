 ...
 * Command line was: qdbusxml2cpp -N -m -i generictypes.h -p nm-dhcp6-configinterface /home/jgrulich/development/projects/libnm-qt/dbus/introspection/nm-dhcp6-config.xml
 *
