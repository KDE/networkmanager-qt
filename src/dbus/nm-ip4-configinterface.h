 ...
 * Command line was: qdbusxml2cpp -N -m -i generictypes.h -p nm-ip4-configinterface /home/jgrulich/development/projects/libnm-qt/dbus/introspection/nm-ip4-config.xml
 *
