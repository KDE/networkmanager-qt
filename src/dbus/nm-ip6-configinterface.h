 ...
 * Command line was: qdbusxml2cpp -N -m -i generictypes.h -p nm-ip6-configinterface /home/jgrulich/development/projects/libnm-qt/dbus/introspection/nm-ip6-config.xml
 *
