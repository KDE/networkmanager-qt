...
public:
     ...
     * \value Generic
     *        Generic device \since 1.0.0
     * \value Team
     *        Team master device \since 1.0.0
     * \value Gre
     *        Gre virtual device \since 1.2.0, \deprecated use IpTunnel instead
     * \value MacVlan
     *        MacVlan virtual device \since 1.2.0
     * \value Tun
     *        Tun virtual device \since 1.2.0
     * \value Veth
     *        Veth virtual device \since 1.2.0
     * \value IpTunnel
     *        IP Tunneling Device \since 1.2.0
     * \value VxLan
     *        Vxlan Device \since 1.2.0
     * \value MacSec
     *        MacSec Device \since 1.6.0
     * \value Dummy
     *        Dummy Device \since 1.8.0
     * \value Ppp
     *        Ppp Device \since 1.10
     * \value OvsInterface
     *        OvsInterface Device \since 1.10
     * \value OvsPort
     *        OvsPort Device \since 1.10
     * \value OvsBridge
     *        OvsBridge Device \since 1.10
     * \value Wpan
     *        Wpan Device \since 1.14
     * \value Lowpan
     *        Lowpan Device \since 1.14
     * \value WireGuard
     *        WireGuard Device \since 1.14
     * \value WifiP2P
     *        WifiP2P Device \since 1.16
     * \value VRF
     *        VRF (Virtual Routing and Forwarding) Device \since: 1.24
     * \value Loopback
     *        Loopback Device \since 1.42
     */
    enum Type {
